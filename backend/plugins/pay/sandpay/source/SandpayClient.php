...
class SandpayClient
{
    ...
    private string $apiUrl = 'https://openapi.sandpay.com.cn';

    public string $request_body = '';
    public string $response_body = '';

    public function __construct(string $accessMid, string $privateKeyPwd, int $isTest, string $publicKeyPath, string $privateKeyPath)
    {
    ...
    //私钥解密
    public function rsaPrivateDecrypt(string $data): string
    {
        $decrypted = '';
