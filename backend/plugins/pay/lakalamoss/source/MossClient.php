...
class MossClient
{
    private static string $gateway_url = 'https://moss.lakala.com/ord-api/unified/v3';
    private static string $platform_public_text = 'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQD3E6H3qfgqF7aKypmSuzMIRuL/pRFMzsyqMlSEzzo2aJqN7w8Lb2tfVRfnAUVKMFyDxUzNWER4E/UfR4ymo0YHOaiIJI3AHWdJngJyGgK+SfvYDs9rqC++yisrzYv/TN3fZ93Ru1YWOYi4x4lBSCC9UX2b28hwx32MpJHT7gIrMQIDAQAB';
    ...
    public function __construct(string $appid, string $mch_private_key)
    {
        $this->appid = $appid;
    ...
    //构建异步通知响应
    public function buildNotifyResponse(array $head, bool $success = true, ?string $message = null): array
    {
        $params = [
            'head' => [
